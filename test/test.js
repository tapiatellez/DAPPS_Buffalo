...
contract('AuctionContract', function (accounts) {
  ...
  it("Should NOT allow to bid more than remaining tokens", function() {
    ...
    ***********/
    ...
    .then(function (result) {
      /*
      We are testing for a negative condition and hence this particular block
      will not have executed if our test case was correct. If this part is
      executed then we throw an error and catch the error to assert false
      */
    ...
    .then(function(result) {
      ...
      ***********/
      ...
      assert.notEqual(result,
                      ...
                      'Winner address is not default address.')
      /**********
